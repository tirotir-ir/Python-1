...
class FullScreenFlashingVirus:
    def __init__(self, root):
        ...
        # Display the text "VIRUS" in the center of the screen
    ...
    def flash_text(self):
        ...
        colors = ['red', 'green', 'blue', 'yellow', 'white', 'magenta', 'cyan']
...
if __name__ == "__main__":
    root = tk.Tk()
    simulator = FullScreenFlashingVirus(root)
    root.mainloop()
