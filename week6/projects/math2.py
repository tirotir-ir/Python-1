...
def calculate_area_perimeter():
    ...
    if shape == "Rectangle":
        try:
            ...
            canvas.create_rectangle(10, 10, 10 + width * 10, 10 + height * 10, outline="black")
        except ValueError:
        ...
        try:
            ...
            perimeter = 4 * side
            result_var.set(f"Area: {area}\nPerimeter: {perimeter}")
            canvas.create_rectangle(10, 10, 10 + side * 10, 10 + side * 10, outline="black")
        except ValueError:
        ...
        try:
            ...
            canvas.create_oval(10, 10, 10 + radius * 20, 10 + radius * 20, outline="black")
        except ValueError:
